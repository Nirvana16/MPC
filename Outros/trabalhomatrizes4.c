...
int main(){
	float **matrizA,*matrizResultante,**matrizR_TRans,**matrizR,*vetorX,*vetorY,m, valor, soma1=0,soma2=0,elemento,soma=0;
    int i,j,k,n; 
   ...
   for(i=0;i<=m;i++){
	  for(j=0;j<=m;j++){
	         ...
	         if(i==j){
                ...
                matrizR[i][i]= sqrt(matrizA[i][i]- soma1);
                soma1 = 0;			 
         }
